...
Метод run выводит не тот текст, который требуется. не работает
Если игрок стал победителем, его метод run должен вывести надпись getName() + ":победитель!". Например: Sidorov:победитель! не работает
 */
