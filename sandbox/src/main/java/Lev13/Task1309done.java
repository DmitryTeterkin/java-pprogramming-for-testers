...
5. В интерфейсе Flyable должен быть объявлен метод speed c одним аргументом типа Flyable и с типом возвращаемого
значения Double.
 */
public class Task1309done {
