...
3. Метод countWords должен добавлять в словарь ключи, соответствующие
уникальным словам, и значения по этим ключам, отображающие сколько раз встречалось слово.
4. Программа должна выводить на экран полученный словарь.
5. Метод main должен вызывать метод countWords.
 */
public class Task1016done {
  ...
  public static Map<String, Integer> countWords(ArrayList<String> list) {
    ...
    while (true) {
      ...
      try {
        ...
        list.trimToSize();
        result.put(s, nach - list.size());
       // System.out.println(s + " " + (nach - list.size()));
